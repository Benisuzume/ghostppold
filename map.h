...
bool GetMapTournament( )
{
  return m_Tournament;
}
uint32_t GetMapTournamentFakeSlot( )
{
  return m_TournamentFakeSlot;
}
string *GetMapData( )
{
  return &m_MapData;
...
vector<uint32_t> GetTournamentLayout( )
{
  return m_TournamentLayout;
}
vector<uint32_t> GetFakePlayers( )
{
  return m_FakePlayers;
}
