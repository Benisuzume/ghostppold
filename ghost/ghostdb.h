...
virtual CDBVampPlayerSummary *GetResult( )
{
  return m_Result;
}
virtual void SetResult( CDBVampPlayerSummary *nResult )
{
  m_Result = nResult;
}
};
...
virtual CDBTreePlayerSummary *GetResult( )
{
  return m_Result;
}
virtual void SetResult( CDBTreePlayerSummary *nResult )
{
  m_Result = nResult;
}
};
...
virtual CDBShipsPlayerSummary *GetResult( )
{
  return m_Result;
}
virtual void SetResult( CDBShipsPlayerSummary *nResult )
{
  m_Result = nResult;
}
};
...
virtual CDBSnipePlayerSummary *GetResult( )
{
  return m_Result;
}
virtual void SetResult( CDBSnipePlayerSummary *nResult )
{
  m_Result = nResult;
}
};
...
virtual CDBW3MMDPlayerSummary *GetResult( )
{
  return m_Result;
}
...
uint32_t GetTotalHumanGames( )
{
  return m_TotalHumanGames;
}
uint32_t GetTotalVampGames( )
{
  return m_TotalVampGames;
}
uint32_t GetTotalHumanWins( )
{
  return m_TotalHumanWins;
}
uint32_t GetTotalVampWins( )
{
  return m_TotalVampWins;
}
uint32_t GetTotalHumanLosses( )
{
  return m_TotalHumanLosses;
}
uint32_t GetTotalVampLosses( )
{
  return m_TotalVampLosses;
}
uint32_t GetTotalVampKills( )
{
  return m_TotalVampKills;
}
double GetMinCommandCenter( )
{
  return m_MinCommandCenter;
}
double GetAvgCommandCenter( )
{
  return m_AvgCommandCenter;
}
double GetMinBase( )
{
  return m_MinBase;
...
uint32_t GetTotalSaves( )
{
  return m_TotalSaves;
}
uint32_t GetTotalEntGames( )
{
  return m_TotalEntGames;
}
uint32_t GetTotalInfernalGames()
{
  return m_TotalInfernalGames;
}
double GetScore( )
{
  return m_Score;
...
float GetAvgKills( )
{
  return m_TotalInfernalGames > 0 ? (float)m_TotalKills / m_TotalInfernalGames : 0;
}
float GetAvgTKs( )
{
  return m_TotalEntGames > 0 ? (float)m_TotalTKs / m_TotalEntGames : 0;
}
float GetAvgDeaths( )
{
  return m_TotalEntGames > 0 ? (float)m_TotalDeaths / m_TotalEntGames : 0;
}
float GetAvgSaves( )
{
  return m_TotalEntGames > 0 ? (float)m_TotalSaves / m_TotalEntGames : 0;
}
};
